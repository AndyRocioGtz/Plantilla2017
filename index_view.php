    <div class="wrapper grid2">
        ...
        <article class="col-5">
            ...
            <ul class="enlaces">
                <li><a href="views/segurenet.php">SEGUREnet</a></li>
                <li><a href="views/consultaremota.php">Consulta Remota</a></li>
    ...
    <div style=" padding-bottom: 20px; width: 100%;">
        <div class="sec1-tramite"><img class="tramites-icon1" src="http://guanajuato.gob.mx/images/tramites/icono1.png"><label class="tittle-tra">Dirección de Registros Públicos</label><br><br>
            <ul class="tramite-lst">
              <li type="circle"><a class="link-tramite-p" href="views/oficinas_rpp.php">Directorio de Oficinas Registrales</a></li>
              <li type="circle"><a class="link-tramite-p" href="views/estadisticas.php">Estadísticas</a></li>
              <li type="circle"><a class="link-tramite-p" href="files/CALENDARIO DIAS INHABILES 2017.pdf">Calendario</a></li>
              <li type="circle"><a class="link-tramite-p" href="views/estruct.php">Estructura General</a></li>
            </ul>
    ...
    <div class="col-6">
        <h1 class="tit-menu"><img class="ico-menu" src="images/normatividad.png" alt="Normatividad"> Normatividad...</h1>
            <ul class="items">
                <li><a href="files/nrrpp2012.pdf">Reglamento RPP GTO. 2012 (Vigente)</a></li>
                <li><a href="files/rrppab.pdf">Reglamento del Registro Público de la Propiedad (Abrogado)</a></li>
                <li><a href="files/1.pdf">Lineamientos de Operación del Registro Público de la Propiedad</a></li>
            </ul>
    </div>
    ...
    <div class="col-6">
           <br><br><br><br>
            <ul class="items">
                <li><a target="_blank" href="files/LEY DE INGRESOS GTO 2017.pdf">Ley de Ingresos Del Estado de Guanajuato</a></li>
                <li><a target="_blank" href="files/criteriosregistrales.pdf">Criterios Registrales del Estado de Guanajuato</a></li>
                <li><a target="_blank" href="files/ACUERDO ADMVO PRODUCTOS 2017.pdf">
    ...
    <article class="col-8">
            <ul class="transparencia">
                <li><a href="views/oficinas_rpp.php">Directorio de Oficinas Registrales</a></li>
                <li><a href="http://www.erpp.guanajuato.gob.mx/dirnot/">Directorio de Notarial</a></li>
                <li><a href="views/estruct.php">Estructura orgánica</a></li>
